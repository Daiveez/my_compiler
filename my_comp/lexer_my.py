...
class Lexer:
    ...
    def __read_number(self) -> Token:
        ...
        while self.__is_digit(self.current_char) or self.current_char == '.':
            ...
            if dot_count > 1:
                print(f"Too many decimals on line {self.line_number}, position {self.position}")
    ...
    def next_token(self) -> Token:
        ...
        match self.current_char:
            ...
            case '*':
                tok = self.__new_token(TokenType.MULTIPLY, self.current_char)
            case '/':
            ...
            case ';':
                tok = self.__new_token(TokenType.SEMICOLONS, self.current_char)    
            case None:
